    ...
    <div class="col-8 mx-auto">
      <form action="/question/{{$question->id}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <textarea name="body" rows="5" class="form-control">{{ old('body') }}{{ $question->body }}</textarea>
          @error('body')
        ...
        <div class="mb-3">
          ...
          選択肢1<input type="text" name="choice_1" class="form-control" value="{{ old('choice_1') }}{{ $question->choice_1 }}">
          @error('choice_1')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        </div>
        <div class="mb-3">
          選択肢2<input type="text" name="choice_2" class="form-control" value="{{ old('choice_2') }}{{ $question->choice_2 }}">
          @error('choice_2')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        </div>
        <div class="mb-3">
          選択肢3<input type="text" name="choice_3" class="form-control" value="{{ old('choice_3') }}{{ $question->choice_3 }}">
          @error('choice_3')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        </div>
        <div class="mb-3">
          選択肢4<input type="text" name="choice_4" class="form-control" value="{{ old('choice_4') }}{{ $question->choice_4 }}">
          @error('choice_4')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        </div>
        <div class="mb-3">
          ...
          <textarea name="answer_body" rows="5" class="form-control">{{ old('answer_body') }}{{ $question->answer_body }}</textarea>
          @error('answer_body')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
        </div>
